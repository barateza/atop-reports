...
- **Issue:** Hardcoded cloud image URLs outdated
- **Impact:** ~5% of user base (RHEL family)
- **Effort:** 2-4 hours (URL updates + regeneration)
- **Available:** Images exist at `repo.almalinux.org/almalinux/{8,9}/cloud/aarch64/images/`
